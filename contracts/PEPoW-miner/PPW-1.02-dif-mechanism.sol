...
contract PEPOWToken is ERC20 {
    ...
    uint256 public maxStakeSize = 50000000000000000000; // Maximum allowable stake per miner
    ...
    constructor(uint256 initialSupply, uint256 difficulty, uint256 reward) ERC20("Macaroni Token", "MAC") {
    ...
    function withdrawStake(uint256 amount) public {
        ...
        _mint(msg.sender, amount); // MintHere is the continuation of the previous message:
        // Mint the withdrawn tokens
